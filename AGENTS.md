...
Trên nhánh `experiment/story-investigation-redesign`, khi nhiệm vụ liên quan chọn câu chuyện, nghiên cứu Schokland, story architecture, route, viết hoặc review, đọc [thử nghiệm kiến trúc](docs/story-investigation-experiment.md) cùng tài liệu đúng vai. Narrative Writer / Revision Writer nhận gói đầu vào riêng theo ngoại lệ dưới đây.
...
**Ngoại lệ khi nhận vai Narrative Writer / Revision Writer trong `experiment/story-investigation-redesign`:** sau file hướng dẫn này, chỉ mở toàn văn dàn ý 11 chặng và những file được liệt kê trong handoff dành cho Writer. Editor chuyển nguyên văn phản hồi có tác dụng, các giới hạn nguồn và phần DNA cần thiết trong gói ấy. Không tự mở các map cạnh tranh, nhật ký A–F, bản nháp/review cũ, `episode.md`, `revisions.md` hay toàn bộ workflow để viết từ một đống context. Nếu thiếu bằng chứng hoặc route không giữ được mạch điều tra, trả về Editor/Curator trước khi viết.
