...
- Bản mới nhất để review và nền biên tập tạm: [V23](drafts/vi-v23-podcast-sample.md); [V21](drafts/vi-v21-podcast-sample.md) là nền được chọn sau R17 nhưng có chỗ quá mức nguồn; [V22](drafts/vi-v22-podcast-sample.md) là bản thử không thay V21; [V20](drafts/vi-v20-podcast-sample.md) giữ để so sức nặng người/nơi, [V19](drafts/vi-v19-podcast-sample.md) là trước phản hồi setup. Các bản R17–R19 và giới hạn kiểm chứng ghi ở [revisions](revisions.md). [V17](drafts/vi-v17-podcast-sample.md) là nền chi tiết, [V18](drafts/vi-v18-podcast-sample.md) thử nhịp gọn, [V16](drafts/vi-v16-podcast-sample.md) là bản đầu vòng. V05/V06 vẫn là mốc chất kể; chủ kênh chưa chọn bản mở hay duyệt toàn tập.
