...
Trạng thái ngày 23/09/2026, sau thử nghiệm viết từ đầu: [bản thử với route tối giản](drafts/vi-fresh-minimal-route-experiment.md) là **bản mới nhất để so trực tiếp**, chưa được review và không tự thay bản nền. [V23](drafts/vi-v23-podcast-sample.md) vẫn là **nền tạm do reviewer chọn sau R19**, chưa được chủ kênh chấp nhận hoặc kiểm nguồn riêng hoàn tất. Ba Writer sub-agent ở context mới lần lượt tạo [V21](drafts/vi-v21-podcast-sample.md) từ V19, [V22](drafts/vi-v22-podcast-sample.md) từ V21 và V23 từ V21 theo các handoff tách biệt; không bản nào được chính Writer tự review. V21 giữ chặng vật liệu, giếng và lưới nhưng còn hai câu vượt nguồn; V22 sửa nguồn ở chỗ ấy nhưng làm nhà mới bớt cụ thể; V23 lấy lại kích thước nhà và một phần vật liệu tái dùng, đổi lại hạn bốn tháng và kết đoạn yếu hơn V21. [V20](drafts/vi-v20-podcast-sample.md) là đối chứng về cách đặt địa danh và nhân vật; V05/V06 vẫn là mốc chất kể, chưa có bản mở hay bản toàn tập được chủ kênh duyệt.
...
Beat & Evidence Curator đã chạy trên v02. [Beat & Evidence Packet v01](working/2026-09-22-beat-evidence-packet-v01.md) là tài liệu nội bộ có ánh xạ chứng cứ và giới hạn nguồn. [Writer-Facing Route v04](working/2026-09-23-writer-route-v04.md) là route **hiện hành** đã hợp nhất ngày mua/chia đất, vết bão, thành phần hộ Jan và hiệu chỉnh Legebeke đã sống trên đảo 26 năm (không chứng minh dạy đủ 26 năm). [Route v02](working/2026-09-23-writer-route-v02.md), [v03](working/2026-09-23-writer-route-v03.md) và [v01](working/2026-09-22-writer-route-v01.md) giữ để đối chiếu lịch sử, không dùng cho bàn giao mới. Chi phí thường niên là một áp lực trong giải trình chính sách, không phải nguyên nhân duy nhất; luật 16/12/1858, thông báo 1/3/1859 và hạn bốn tháng là ba việc khác nhau. V13 chỉ còn là draft thử, không dùng làm outline hoặc nguồn architecture.
...
V23 là nền **tạm** cho lần biên tập tiếp theo. Cần cân nhắc trả sức ép cho hạn bốn tháng, nối Legebeke trở lại rõ hơn và kết bằng công dụng của căn nhà mới thay vì lặp giếng, đồng thời không tự thêm hành động cho hộ Jan. Trước sản xuất phải kiểm nguồn riêng V23 và nghe đọc thành tiếng; chưa có phản hồi chấp nhận từ chủ kênh. Các mục R11/R12 dưới đây là bối cảnh và nhánh bàn giao trước đó.

Lượt thử mới tạo [route bảy bước](working/2026-09-23-minimal-progression-route.md) và [bảng chứng cứ tách riêng](working/2026-09-23-minimal-evidence-sheet.md) từ story map v02 không sửa. Một Writer khác chỉ đọc [handoff](working/2026-09-23-fresh-narrative-writer-handoff.md) và hai tệp đó, **không đọc V05/V06 hoặc V14–V23**, viết một bản rồi dừng. [Bản thử](drafts/vi-fresh-minimal-route-experiment.md) giữ riêng, chưa so sánh hay chọn nền; xem [R20](revisions.md) để biết giới hạn phép thử.
...
- Bản thử mới nhất để so: [bản viết từ đầu với route tối giản](drafts/vi-fresh-minimal-route-experiment.md), chưa review; nền biên tập tạm của chuỗi sửa vẫn là [V23](drafts/vi-v23-podcast-sample.md). [V21](drafts/vi-v21-podcast-sample.md) là nền sau R17 nhưng có chỗ quá mức nguồn; [V22](drafts/vi-v22-podcast-sample.md) là thử nghiệm không thay V21; [V20](drafts/vi-v20-podcast-sample.md) giữ làm đối chứng, [V19](drafts/vi-v19-podcast-sample.md) là trước phản hồi setup. Các bản R17–R20 và giới hạn kiểm chứng ở [revisions](revisions.md). [V17](drafts/vi-v17-podcast-sample.md) là nền chi tiết, [V18](drafts/vi-v18-podcast-sample.md) thử nhịp gọn, [V16](drafts/vi-v16-podcast-sample.md) là bản đầu vòng. V05/V06 vẫn là mốc chất kể; chủ kênh chưa chọn bản mở hay duyệt toàn tập.
