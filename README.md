...
Đang phát triển [tập Schokland](episodes/schokland/episode.md). Sau R08 về phần mở còn lan man, bản thử hiện tại là **[phần mở v12](episodes/schokland/drafts/vi-v12-opening.md)**: bến cảng trên cạn, cuộc di dời và vùng nước quanh đảo thành đất; [ghi chú và nguồn](episodes/schokland/working/2026-09-22-v12-opening-note.md). Chưa có phần mở được chủ kênh chọn. V10/v11 lưu các vòng sửa không đạt; [v05](episodes/schokland/drafts/vi-v05-sample.md) vẫn là mốc phản hồi tích cực có điều kiện. [Lịch sử sửa](episodes/schokland/revisions.md) giữ phản hồi nguyên văn; [đối chiếu về trị thủy Hà Lan](episodes/schokland/working/2026-09-22-dutch-water-openings.md) lưu nghiên cứu R07 cùng cập nhật trạng thái sau phản hồi.
