...
Đang phát triển [tập Schokland](episodes/schokland/episode.md). Sau phản hồi về cách đặt vấn đề ở v08, bản đề xuất để đọc tiếp là **[phần mở tiếng Việt v10](episodes/schokland/drafts/vi-v10-opening.md)**. [V09](episodes/schokland/drafts/vi-v09-opening.md) lưu cách mở thử trước đó; [v08](episodes/schokland/drafts/vi-v08-sample.md) giữ nguyên như đoạn giữa tập, chưa ghép với phần mở. [Hồ sơ vòng sửa](episodes/schokland/working/2026-09-22-opening-review.md) ghi vì sao đổi điểm vào và căn cứ theo đoạn. [V05](episodes/schokland/drafts/vi-v05-sample.md) vẫn là mốc chủ kênh đã phản hồi tích cực có điều kiện; chưa có bản được duyệt cuối. [Đối chiếu các chương trình ở R04](episodes/schokland/working/2026-09-22-benchmark-and-review.md) và [lịch sử sửa](episodes/schokland/revisions.md) giữ quyết định qua từng vòng.
