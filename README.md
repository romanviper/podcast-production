...
Đang phát triển [tập Schokland](episodes/schokland/episode.md). Đầu ra mới nhất là **[review nhánh và trách nhiệm chuyển phản hồi thành quyết định viết, R10](episodes/schokland/working/2026-09-22-editorial-decision-audit.md)**: các phẩm chất của v05/v06 đã được ghi nhận nhưng chưa được bảo toàn trong đầu ra từ v09 trở đi. [Chuẩn đối chiếu R09](episodes/schokland/working/2026-09-22-writer-benchmark.md) vẫn được giữ, kèm giới hạn áp dụng. V12 là draft mới nhất, không phải mốc chất lượng được chọn; chưa có v13. [Lịch sử sửa](episodes/schokland/revisions.md) giữ phản hồi nguyên văn. Lượt review không sửa draft, DNA hoặc workflow.
